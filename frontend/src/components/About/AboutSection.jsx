...
const About = () => {
  ...
  return (
    <>
      {/* About us */}
      <div className="relative flex text-gray-800 justify-center flex-row mx-auto bg-vuejs-400 leading-8">
          <div
              className="relative w-2/5 lg:w-3/12 m-4 overflow-hidden text-gray-800 bg-white rounded-lg shrink-0">
              <img
              src={bg}
          ...
          <div className="p-4 w-3/5 lg:w-8/12">
              ...
              <h3 className="block mb-2 font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-white">
              About us
              </h3>
              ...
              <a href="/about" className="inline-block"><button
                  className="flex items-center gap-2 hover:px-2 py-3 font-sans text-xs font-bold text-center text-white uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:underline"
                  type="button">
      ...
      {/* About Captain */}
      <div className="relative flex text-gray-800 justify-center flex-row mx-auto bg-white">
          <div className="p-4 w-3/5 lg:w-8/12">
            
              <h3 className="block mb-2 font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-gray-800">
              About Captain
              </h3>
              <p className="block mb-8 font-sans text-base antialiased font-normal leading-relaxed text-gray-800">
              ...
              <a href="/about" className="inline-block"><button
                  className="flex items-center gap-2 hover:px-2 py-3 font-sans text-xs font-bold text-center text-gray-800 uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:underline"
                  type="button">
                  Read More<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"  stroke="currentColor"
                  strokeWidth="2" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3"></path>
          ...
          <div
              className="relative h-64 w-2/5 lg:w-3/12 m-4 overflow-hidden text-gray-800 bg-white rounded-md shrink-0">
              <img
              src={captain}
      ...
      {/* About Boat */}
      <div className="relative flex text-gray-800 justify-center flex-row mx-auto bg-vuejs-400">
          <div
              className="relative w-2/5 lg:w-3/12 m-4 overflow-hidden text-gray-800 bg-white rounded-lg shrink-0">
              <img
              src={bg}
