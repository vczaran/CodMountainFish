    ...
    <>
      ...
      <div className="relative flex text-gray-700 justify-center flex-row mx-auto bg-white">
          <div className="p-4 w-3/5 lg:w-8/12">
              ...
              <a href="/about" className="inline-block"><button
                  className="flex items-center gap-2 hover:px-2 py-3 font-sans text-xs font-bold text-center text-gray-700 uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:bg-gray-900/10 active:bg-gray-900/20"
                  type="button">
                  Read More<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"  stroke="currentColor"
                  strokeWidth="2" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3"></path>
