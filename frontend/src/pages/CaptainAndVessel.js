...
export default function CaptainAndVessel() {
  return (
    <div>
      ...
      <p>Captain Greg Webb brings over a decade of dedicated experience and a genuine love for fishing to Cod Mountain Fish Co. 
      ...
      <p>Throughout his career, Captain Greg's passion for fishing led him to continuously expand his knowledge and refine his skills. 
      ...
      <p>As the owner and operator of Cod Mountain Fish Co., Captain Greg remains committed to providing exceptional service and memorable 
      ...
      <p>Captain Greg's dedication to customer satisfaction is rooted in his genuine care and attention to detail. Whether you're a seasoned 
      ...
      <p>With Captain Greg at the helm, you can expect a down-to-earth approach that focuses on creating an atmosphere of camaraderie and fun on 
      ...
      <p>When you choose to embark on a fishing adventure with Captain Greg and Cod Mountain Fish Co., you can trust that you're in the hands of a 
