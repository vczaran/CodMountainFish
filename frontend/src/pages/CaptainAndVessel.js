  ...
  return (
    <div className='grid grid-cols-2 gap-5 w-full mt-10 leading-8'>
      ...
      <div className='mt-10 mb-10 space-y-4'>
        ...
        <Link className="bg-sky-800 text-white active:bg-sky-900 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md hover:underline mr-1 mb-1 ease-linear transition-all duration-150" to="/availability">Book Now</Link>
      </div>
    </div>
  )
}
